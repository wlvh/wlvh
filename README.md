...
| --- | --- |
| Spec-blind acceptance agents for reducing structural collusion in multi-agent coding workflows | [acceptance-agent](https://github.com/wlvh/acceptance-agent) |
| Bilingual technical publishing infrastructure behind Huaweidata | [huaweidata.com](https://huaweidata.com) |
| Runtime contract gates for NL->DAX generation and Power BI execution | Public case study planned |
| Rolling quant validation methods with multi-freeze ablation and walk-forward evidence | Public methodology note planned |
